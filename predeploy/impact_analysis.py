    ...
    *,
    ...
    if legacy:
        ...
        legacy["change_assurance"] = {
            ...
            "permission_ready": report.get("permission_ready"),
            "execution_permission_assessment": report.get("execution_permission_assessment"),
            "execution_capability": report.get("execution_capability"),
            "capability_bootstrap": report.get("capability_bootstrap"),
            "bootstrap_authorization_status": report.get("bootstrap_authorization_status"),
            "execution_gate": report.get("execution_gate"),
            "guardduty_permission_package": report.get("guardduty_permission_package"),
            "staged_remediation": report.get("staged_remediation"),
            "planning_profile": report.get("planning_profile"),
            "planning_identity": report.get("planning_identity"),
            "manager_considerations": report.get("manager_considerations"),
        ...
        for key in (
            ...
            "permission_ready",
            "execution_permission_assessment",
            "execution_capability",
            "capability_bootstrap",
            "bootstrap_authorization_status",
            "execution_gate",
            "guardduty_permission_package",
            "staged_remediation",
            "planning_profile",
            "planning_identity",
