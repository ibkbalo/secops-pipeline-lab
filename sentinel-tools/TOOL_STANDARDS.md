...
sentinel-tools/ ├── cloud-security/ # Infrastructure Sentinel │ ├── aws/ │ ├── azure/ │ └── gcp/ ├── devsecops/ # Infrastructure Sentinel │ ├── cicd/ │ ├── containers/ │ ├── iac/ │ └── secrets/ ├── appsec/ # Perimeter Sentinel │ ├── owasp/ │ ├── dependency-scanning/ │ └── api-security/ ├── identity-access/ # Infrastructure Sentinel │ ├── iam/ │ ├── mfa/ │ └── privileged-access/ ├── ai-ml-security/ # Perimeter Sentinel │ ├── prompt-injection/ │ ├── model-integrity/ │ └── data-poisoning/ ├── governance/ # Command Center │ ├── compliance/ │ └── reporting/ └── \_templates/
...
A machine-readable index located at the root of sentinel-tools/. The AI Agent uses this file to discover available tools.
